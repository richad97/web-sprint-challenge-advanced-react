...
1. What are the main differences between a stateful and a functional component?
   ...
   -The main differences involve state. A stateful component has the complexity of having state within it while a functional component does not.

2. When does a componentWillMount function be called? What about a componentWillUpdate?

   -Both are depricated. componentWillMount is executed before rendering in the mounting process of the lifecycle. componentWillUpdate will is executed right before rendering in the updating proccess of the lifecycle.

3. Define stateful logic.

   -Stateful logic is logic that only deals with state. This will usually be a custom hook.

4. What are the three step of creating a successful test? What is done in each phase?

   -Arrage, act, and assert. We grab whatever component we are testing, we then call on the elements needed a mimic events, then we write what we expect to happen in the tests.
